...
public class _I1Stub extends org.omg.CORBA.portable.ObjectImpl implements org.corba.generated.I1
{
  ...
  public String op2 (String text, org.omg.CORBA.StringHolder text2, org.omg.CORBA.StringHolder text3, org.corba.generated.S1 struct1)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                org.corba.generated.S1Helper.write ($out, struct1);
                $in = _invoke ($out);
  ...
  public org.corba.generated.I2 getI2 ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getI2", true);
                $in = _invoke ($out);
                org.corba.generated.I2 $result = org.corba.generated.I2Helper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
