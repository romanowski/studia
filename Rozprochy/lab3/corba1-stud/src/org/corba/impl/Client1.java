...
public class Client1 {
	...
	public void base1(String[] args) throws InvalidName, NotFound,
		...
		org.omg.CORBA.Object objRef = orb
				.string_to_object(path);

		// narrow the reference
		i1 = I1Helper.narrow(objRef);
	}

	public void base2(String[] args) throws InvalidName, NotFound,
			CannotProceed, org.omg.CORBA.ORBPackage.InvalidName {
		// create and initialize the ORB
		orb = ORB.init(args, null);
		...
		org.omg.CORBA.Object objRef = ncRef
				.resolve_str("alamakota/TextFunctionsServerxx");
