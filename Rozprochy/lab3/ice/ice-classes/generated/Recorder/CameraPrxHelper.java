...
public final class CameraPrxHelper extends Ice.ObjectPrxHelperBase implements CameraPrx
{
    ...
    rotate(int xy, int z)
    {
        rotate(xy, z, null, false);
    }

    public void
    rotate(int xy, int z, java.util.Map<String, String> __ctx)
    {
        rotate(xy, z, __ctx, true);
    }

    private void
    rotate(int xy, int z, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    private Ice.AsyncResult begin_rotate(int xy, int z, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
