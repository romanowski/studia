...
public abstract class MonitorPOA extends org.omg.PortableServer.Servant
 implements Displays.MonitorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("doOperation", new java.lang.Integer (2));
    _methods.put ("operations", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Displays/Monitor/rotate
       {
         int degree = in.read_long ();
         this.rotate (degree);
         out = $rh.createReply();
         break;
       }

       case 1:  // Laboratory/Dev/info
       {
       ...
       case 2:  // Laboratory/Dev/doOperation
       {
         try {
       ...
       case 3:  // Laboratory/Dev/operations
       {
