...
{
    public Dev[] getDevsInfo();

    public Dev[] getDevsInfo(java.util.Map<String, String> __ctx);
    ...
    public Dev[] end_getDevsInfo(Ice.AsyncResult __result);

    public Dev viewDev(String ID);

    public Dev viewDev(String ID, java.util.Map<String, String> __ctx);
    ...
    public Dev end_viewDev(Ice.AsyncResult __result);
