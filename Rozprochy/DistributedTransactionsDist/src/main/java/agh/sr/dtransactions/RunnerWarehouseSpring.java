...
import agh.sr.dtransactions.orderprocessing.logic.impl.WarehouseManagerImpl_SpringMultipleTx;
import agh.sr.dtransactions.orderprocessing.logic.impl.WarehouseManagerImpl_SpringTx;
...
public class RunnerWarehouseSpring {
	...
	public void testSpring_Local_Badly() throws Throwable {
		...
		new SpringTx().makeExOnDecrease(); /*
											 * logging should not be //
	...
	public void testSpring_Local() throws Throwable {
		 ...
		 * 
		 * new SpringTx().makeCommit(); ok new SpringTx().makeExOnDecrease();
		 * will rollback all new SpringTx().makeExOnLogging(); will rollback all
		 */

		new SpringMultipleTx().makeCommit(); /* ok */
		new SpringMultipleTx().makeExOnDecrease(); /*
													 * will rollback al beside
													 * logging
													 */
		new SpringMultipleTx().makeExOnLogging(); /*
												 * will rollback only audit //
												 */
	}
