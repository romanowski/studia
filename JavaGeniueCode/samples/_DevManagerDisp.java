...
public abstract class _DevManagerDisp extends Ice.ObjectImpl implements DevManager
{
    ...
    public final StatePrx
    devState(String ID)
    {
        return devState(ID, null);
    }
    ...
    ___getDevsInfo(DevManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        DevS[] __ret = __obj.getDevsInfo(__current);
    ...
    ___viewDev(DevManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        DevS __ret = __obj.viewDev(ID, __current);
        __ret.__write(__os);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    public static Ice.DispatchStatus
    ___devState(DevManager __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        __is.endReadEncaps();
        IceInternal.BasicStream __os = __inS.os();
        StatePrx __ret = __obj.devState(ID, __current);
        StatePrxHelper.__write(__os, __ret);
        return Ice.DispatchStatus.DispatchOK;
    }
    ...
    __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 1:
            {
                return ___devState(this, in, __current);
            }
            case 2:
            {
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type Laboratory::DevManager was not generated with stream support";
        throw ex;
    }
